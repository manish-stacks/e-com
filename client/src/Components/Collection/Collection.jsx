    ...
    <div className="group relative bg-white rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-gray-200">
      ...
      <div className="p-6 space-y-4">
        <div>
          ...
          <h3 className="text-lg font-bold text-gray-900 group-hover:text-[#81190B] transition-colors">
            {product.name}
          </h3>
        </div>
        ...
        {/* Add to Cart Button */}
        <button className="w-full bg-[#81190B] text-white py-3 rounded-xl font-medium hover:bg-blue-600 transition-all duration-300 flex items-center justify-center gap-2 group-hover:scale-105">
