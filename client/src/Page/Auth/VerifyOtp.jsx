...
const VerifyOtp = ({ onVerificationSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://api.grandmasala.in/api/v1/verify-otp', {
                method: 'POST',
                headers: {
    ...
    const handleResendOtp = async () => {
        ...
        try {
            // Using the same API endpoint as the Otp component
            const response = await fetch('https://api.grandmasala.in/api/v1/resend-otp', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                ...
                <div className="relative z-10 bg-white/95 backdrop-blur-sm rounded-3xl p-8 max-w-md w-full text-center shadow-2xl">
                    ...
                    <p className="text-gray-600 mb-6">
                        {successMessage || (type === 'register' 
                            ? 'Your account has been verified successfully. Welcome to Grand Masala!' 
