...
const Cart = () => {
  ...
  const shipping = cartSubtotal >= 299 ? 0 : 80;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Link to="/shop" className="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {cartItems.length === 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <Link
              to={"/shop"}
              className="bg-[#81190B] text-white px-8 py-3 rounded-lg font-medium hover:bg-[#81190B] transition-colors"
            >
              Start Shopping
            </Link>
          </div>
                      ...
                      <div key={item.product} className="p-6 hover:bg-gray-50 transition-colors">
                        <div className="flex items-center space-x-4">
                          ...
                          <button
                            ...
                            className="bg-[#81190B] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#81190B] transition-colors"
                          >
                            Add to Cart
                          </button>
                        </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-8">
                ...
                {cartSubtotal < 299 && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-6">
                    <p className="text-sm text-blue-800 font-medium">
                      Add ₹{(299 - cartSubtotal).toFixed(2)} more for FREE delivery!
                    </p>
                  </div>
                )}
                ...
                <Link
                  ...
                  className="w-full bg-[#81190B] text-white py-4 rounded-lg font-semibold text-lg hover:bg-[#81190B] transition-colors mb-3 block text-center"
                >
                  Proceed to Checkout
                </Link>
