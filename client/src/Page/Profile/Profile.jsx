...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrder = async () => {
      ...
      try {
        const { data } = await axios.get(
          "https://api.grandmasala.in/api/v1/my-all-order",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      const { data } = await axios.delete(
        "https://api.grandmasala.in/api/v1/delete-account",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleRefundRequest = async () => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://api.grandmasala.in/api/v1/refund-request-order/${selectedOrder._id}`,
        {
