                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            <ShoppingBag className="h-8 w-8 text-[#81190B]" />
                            ...
                            <div className="relative">
                                ...
                                >
                                    <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center">
                                        <User className="h-6 w-6 text-[#81190B]" />
                                    </div>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div className="flex space-x-3">
                                                    <button
                                                        ...
                                                        className="text-[#81190B] hover:text-blue-900 flex items-center"
                                                    >
                    ...
                    <div className="bg-white rounded-lg max-w-2xl w-full p-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    <Package className="h-5 w-5 text-[#81190B] mr-2" />
                            ...
                            <div className="border-t pt-4">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="font-medium text-[#81190B]">₹{selectedOrder.totalAmount}</span>
                                </div>
                            </div>
                        </div>
                    </div>
